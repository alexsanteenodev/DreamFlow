...
class DatePicker extends Component {
    ...
    setModalVisible(visible) {
        ...
        if (visible) {
            ...
            let self = this;
            let newTime = (new Date(self.getDate())).setTime((new Date(self.getDate())).getTime()+1);
            setTimeout(function () {
                self.setState({
    ...
    getTitleElement() {
        ...
        if (!date && placeholder) {
            return (
                <MyText allowFontScaling={allowFontScaling} style={[Style.placeholderText, customStyles.placeholderText]}>
                    {placeholder}
                </MyText>
            );
        }
        return (
            <MyText allowFontScaling={allowFontScaling} style={[Style.dateText, customStyles.dateText]}>
                {this.getDateStr()}
            </MyText>
        );
    }
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        ><MyText allowFontScaling={allowFontScaling}
